...
import (
	"os"
	v1GetOrder "root/components/order/lambda-v1-get-order/incoming"
	v1GetOrders "root/components/order/lambda-v1-get-orders/incoming"
	v1PostOrders "root/components/order/lambda-v1-post-orders/incoming"
)
